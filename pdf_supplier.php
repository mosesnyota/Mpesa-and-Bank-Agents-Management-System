...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "All Suppliers" , 0, 0, "C", 0);
...
$pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       ...
       $pdf->Cell(65, 7, "Contact Person", 1, 0, "l", 1);
       $pdf->Cell(65, 7, "Company Name", 1, 0, "l", 1);
       $pdf->Cell(40, 7, "Phone No", 1, 0, "l", 1);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(65, 7, $row['contact_person'], 1, 0, "L", $fill);
    $pdf->Cell(65, 7, $row['company_name'], 1, 0, "l", $fill);
    $pdf->Cell(40, 7, $row['phone'], 1, 0, "r", $fill);
