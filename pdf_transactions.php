...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "All Transactions" , 0, 0, "C", 0);
...
$pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       $pdf->Cell(30, 7, "Account", 1, 0, "C", 1);
       $pdf->Cell(50, 7, "Name/Acc", 1, 0, "C", 1);
       $pdf->Cell(30, 7, "Code", 1, 0, "C", 1);
       $pdf->Cell(30, 7, "Acc/Phone", 1, 0, "C", 1);
       $pdf->Cell(15, 7, "Type", 1, 0, "C", 1);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(30, 7, str_replace("&", "'", $row['account_type']), 1, 0, "L", $fill);
    $pdf->Cell(50, 7, $row['account_name'], 1, 0, "L", $fill);
    $pdf->Cell(30, 7, $row['trans_code'], 1, 0, "L", $fill);
    $pdf->Cell(30, 7, $row['trans_acct'], 1, 0, "L", $fill);
    $pdf->Cell(15, 7, $row['trans_type'], 1, 0, "C", $fill);
    $pdf->Cell(30, 7, number_format($row['trans_amount'],2), 1, 0, "R", $fill);
