...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "All Customers" , 0, 0, "C", 0);
...
$pdf->Cell(10, 7, "#", 1, 0, "L", 1);
       ...
       $pdf->Cell(100, 7, "Full Name", 1, 0, "C", 1);

       $pdf->Cell(70, 7, "Phone No", 1, 0, "C", 1);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(100, 7, $row['fname']." ".$row['mname']." ".$row['lname'], 1, 0, "L", $fill);

    $pdf->Cell(70, 7, $row['phone'], 1, 0, "R", $fill);
