           ...
           ?>    
               <tr>
                  ...
                  <td><b> <?php echo $row['balance']; ?></b></td>
                   ...
                   <td><a href="product_add.php?id=<?php echo $row['cust_id'] ?>" title="Click View Report"><i  <button type="button" class="btn btn-warning btn-sm"><b class="fa fa-plus-circle" ></b> View Report</button></a></td>
