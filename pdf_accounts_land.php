...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "All Accounts" , 0, 0, "C", 0);
...
$pdf->Cell(40, 7, "Account", 1, 0, "C", 1);
$pdf->Cell(70, 7, "Name/Acc", 1, 0, "C", 1);
$pdf->Cell(50, 7, "Other", 1, 0, "C", 1);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(40, 7, str_replace("&", "'", $row['account_type']), 1, 0, "L", $fill);

    $pdf->Cell(70, 7, $row['account_name'], 1, 0, "L", $fill);
    $pdf->Cell(50, 7, $row['other_info'], 1, 0, "L", $fill);
