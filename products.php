          ...
          <div class="box-footer clearfix no-border">
           ...
           ?>    
               <tr>
                ...
                <td><a href="product_add.php?id=<?php echo $row['product_id'] ?>" title="Click to Edit Customer Details"><i  <button type="button" class="btn btn-warning btn-sm"><b class="fa fa-plus-circle" ></b> Add Stock</button></a></td>
