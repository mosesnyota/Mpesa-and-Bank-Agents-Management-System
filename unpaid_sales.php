        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" align="right">
                <a href="pdf_unpaid_sales.php?from=<?php echo $from;?>&to=<?php echo $to;?>" target="_blank" class="success"><i class='glyphicon glyphicon-print'></i>&nbsp;Print PDF</a>
            </div>
           ...
           ?>    
               <tr>
                  ...
                  <td> <b><?php echo $row['saledate']; ?></b></td>
                  <td><b> <?php echo $row['total']; ?></b></td>
                  <td><b> <?php echo $row['paid']; ?></b></td>
                  <td> <b><?php echo $row['balance']; ?></b></td>
                
                  <td><a href="receive_payment.php?id=<?php echo $row['sales_id'] ?>" title="Receive pay"><i  <button type="button" class="btn btn-success btn-sm"><b class="fa fa-paypal" ></b> Receive Payment</button></a></td>
              ...
              <?php }  ?>    
                ...
                <tfoot>
                    ...
                    <td><b> <?php echo "Ksh. ".number_format($totalSale,2); ?></b></td>
                     <td><b> <?php echo "Ksh. ".number_format($totalPaid,2); ?></b></td>
                    <td><b> <?php echo "Ksh. ".number_format($totalBalance,2); ?></b></td>
                </tfoot>
              </table>
            </div>
            <!-- /.box-body -->
