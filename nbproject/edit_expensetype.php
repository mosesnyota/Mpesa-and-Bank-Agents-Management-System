...
function WarningDelete(id) {
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div class="forms">
					...
					<div class="row">
						<h3 class="title1">EDIT EXPENSE TYPE</h3>
						...
						<div class="form-three widget-shadow">
                            ...
                            if(isset($_GET['id'])){
                                  $myid = $_GET['id'];
                            $statement = "SELECT * FROM expense_types WHERE expense_type_id ='$myid' ";
                            $result = $db->query($statement);
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" name = "incomesource" class="form-control1" id="firstname" value="<?php echo $row['expense_type']?>" required>
									</div>
									...
									<div class="col-sm-8">
										<input type="text" name = "description" class="form-control1" id="middlename" value="<?php echo $row['description']?>" required>
                                                    ...
                                                    <input type="hidden" name = "myid" class="form-control1" id="myid" value="<?php echo $row['expense_type_id']?>" >
                                                    <?php }}?>
	...
	$qury="UPDATE expense_types SET expense_type = '$name', description='$acctname' WHERE expense_type_id='$myid'";
	...
	die('Invalid query: ' . mysqli_error($db));
		...
		echo "<script language=javascript>alert('Expense Type Updated Successfuly') </script>";
