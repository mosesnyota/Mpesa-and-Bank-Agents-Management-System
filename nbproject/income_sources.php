...
<html>
        ...
        <script type="text/javascript" language="javascript" class="init">
                        ...
                        function WarningDelete(id) {
                            ...
                            if (confirm("WARNING !!\n\nYou are about to delete this Staff\n\nDo you want to continue?")) {
                                ...
                                window.location = "delete_income_source.php?id=" + id;
                                /* $.ajax({
                                 type: "GET",
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div class="forms">
					...
					<div class="row">
						<h3 class="title1">DEFINE INCOME TYPES</h3>
						...
						<div class="form-three widget-shadow">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" name = "incomesource" class="form-control1" id="firstname" placeholder="Income Source" required>
									</div>
									...
									<div class="col-sm-8">
										<input type="text" name = "description" class="form-control1" id="middlename" placeholder="Description" required>
									</div>
							      </div>
	...
	include('dao/connect.php');
        ...
        $name= str_replace("'","&",$_POST['incomesource']); 
	$acctname= str_replace("'","&",$_POST['description']); 

	
	
	$qury="insert into income_sources (source_name,description) values ('$name','$acctname')
			  on duplicate key update source_name='$name', description='$acctname'";
	...
	die('Invalid query: ' . mysqli_error($db));
		...
		echo "<script language=javascript>alert('Income Type Added Successfuly') </script>";
...
?>
                                                        <?php
                             include('dao/connect.php');
                            $statement = "Select * from income_sources";
                                            ...
                                            <tbody>
                                                ...
                                                $num = 0;
                                                 ...
                                                 while($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td>' . str_replace("&", "'", $row['source_name'])   . '</td>';
                                                    ...
                                                    ?>
                                               <td><a href="edit_incomesource.php?id=<?php echo $row['source_id'] ?>" title="Click to Edit Members Details"><i  <button type="button" class="btn btn-success hvr-icon-float-away btn-sm btn-md"><i class="fa fa-plus" aria-hidden="true"></i> Edit</button></a></td>
                                                <td> <a href="#" onclick="return WarningDelete(<?php echo $row['source_id'] ?>);" title="Click To Delete"><i <button type="button" class="btn btn-danger btn-sm hvr-icon-sink-away"><i class="fa fa-plus" aria-hidden="true"></i> Delete</button></i></a></td>		
