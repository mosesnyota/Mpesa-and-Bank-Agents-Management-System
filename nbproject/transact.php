            ...
            <div id="page-wrapper">
             ...
             <div class="main-page">  
                 <div  class="activity_box activity_box2">
                        ...
                        <h3 class="title1">Transact on Available Plots</h3>
                                    ...
                                    <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                $num = 0;
                                                 ...
                                                 <td><a href="sellplot.php?id=<?php echo $row['plot_id'] ?>" title="Click to Sell Plot Details"><i  <button type="button" class="btn btn-success  btn-sm"><i class="fa fa-paypal" aria-hidden="true"></i> Sell </button></a></td>    
