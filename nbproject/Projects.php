...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="main_page.php"><span class="fa fa-area-chart"></span> ProNet ERP<span class="dashboard_text">Design dashboard</span></a></h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="newstaff.php"><i class="fa fa-angle-right"></i> New Project</a></li>
	...
	<div class="col-md-6 chit-chat-layer1-left">
     ...
     <div class="clearfix"> </div>
		...
		<!--footer-->
		<div class="footer">
		   <p>&copy; ProNet ERP | Design by <a href="#" target="_blank">ProperNet Solutions</a></p>
	   </div>
        <!--//footer-->
	</div>
