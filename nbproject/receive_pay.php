			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="activity_box activity_box2">
						<h3 class="title1">RECEIVE PAYMENT FOR A PLOT</h3>
                                                <form class="form-horizontal" id="new_employee"  action="save_payment.php" name="newproject" method="post"  enctype="multipart/form-data">
						<div class="form-three widget-shadow">
								...
								<div class="form-group">
									...
									<input  type="text" name="titleno" id="titleno" STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #d8caa9;" disabled="disabled" class="form-control1" id="titleno"   value="<?php echo $row['title_no'] ?>" >
                                                                ...
                                                                <div class="form-group">
									<label for="set_price" class="col-sm-2 control-label">Amount</label>
									<div class="col-sm-8">
									<input  type="text" name = "set_price" class="form-control1" id="set_price"    required>
									</div>
								</div>
                                                    
                                                             <div class="form-group">
                                                                        <label for="expensetype" class="col-sm-2 control-label">Payment Type</label>
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <select name="expensetype" id="dealer"    required >
                                                                                ...
                                                                                $resultw = $db->query("SELECT * FROM income_sources");
                                                                                while ($roww = $resultw->fetch_assoc()) {
                                                                                    ?>
                                                                                    <option value="<?php echo $roww['source_id']; ?>"><?php echo $roww['source_name'] ; ?></option>
                                                                                    <?php
                                                                                }
                                                                                ?> 
                                                                            </select></div>
