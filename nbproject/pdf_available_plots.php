...
//Page header
    function Header() {
        ...
        $this->Cell(195, 6, "Available Plots :  Call " . $phone, 0, 0, "C", 0);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(90, 7, str_replace("&", "'", $row['name']), 1, 0, "L", $fill);

    $pdf->Cell(20, 7, $row['plot_num'], 1, 0, "L", $fill);
    $pdf->Cell(25, 7, $row['size'], 1, 0, "L", $fill);
