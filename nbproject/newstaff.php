	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="main_page.php"><span class="fa fa-area-chart"></span> Glance<span class="dashboard_text">Design Dashboard</span></a>
          </div>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						<h3 class="title1">New Employee</h3>
                                                <form class="form-horizontal" id="new_employee"  action="save_newstaff.php" name="newstaff" method="post"  enctype="multipart/form-data">
						<div class="form-three widget-shadow">
								...
								<div class="form-group">
									<label for="lastname" class="col-sm-2 control-label">Last Names</label>
									<div class="col-sm-8">
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input  type="text"name = "kra" class="form-control1" id="kra"   placeholder="ID Number">
									</div>
								</div>
                                                               <div class="form-group">
								...
								<div class="form-group">
									<label for="project" class="col-sm-2 control-label">Assigned Project</label>
									<div class="col-sm-8"><select name="project" id="project" class="dropdown-content">
										...
										<option>University</option>
                                                            ...
                                                            <div class="form-group">
									<label for="department" class="col-sm-2 control-label">Branch/Location</label>
									<div class="col-sm-8"><select name="department" id="department" class="dropdown-content">
									...
									<div class="col-sm-8"><select name="education" id="education" class="dropdown-content">
