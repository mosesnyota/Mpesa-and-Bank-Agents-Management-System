    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div class="forms">
						...
						<h3 class="title1">Update Member Details: <?php echo $row['first_name']." ".$row['middle_name']." ".$row['last_name']; ?></h3>
                                                <form class="form-horizontal" id="new_employee"  action="member_update.php" name="newstaff" method="post"  enctype="multipart/form-data">
