			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="activity_box activity_box2">
						<h3 class="title1">SELL A PLOT</h3>
						...
						<div class="form-three widget-shadow">
								...
								<div class="form-group">
									...
									<input  type="text" name = "set_price" class="form-control1" id="set_price"    required>
                                                    ...
                                                    <div class="form-group">
                                                                        <label for="dealer" class="col-sm-2 control-label">Brokers</label>
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <select name="dealer" id="dealer"    required >
                                                                                ...
                                                                                while ($roww = $resultw->fetch_assoc()) {
                                                                                    ?>
                                                                                    <option value="<?php echo $roww['broker_id']; ?>"><?php echo $roww['first_name']." ".$roww['middle_name'] ; ?></option>
                                                                                    <?php
                                                                                }
                                                                                ?> 
                                                                            </select></div>
