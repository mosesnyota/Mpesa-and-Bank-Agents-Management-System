...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <form method="get" action="incomereport.php" target="reportView">
    ...
    <table width="90%">
      <tr>
        ...
        <td valign="middle" rowspan="3"><input   type="submit" name="submit" class="btn btn-primary"  value="Apply Filter" /></td>
                     ...
                     <iframe name="reportView" id='ifm' src="incomereport.php" style="width: 100%; height: 500px;" frameborder="0"></iframe>
