            ...
            <div id="page-wrapper">
             ...
             <div class="main-page">  
                 <div  class="activity_box activity_box2">
                        ...
                        <h3 class="title1">Sold Plots</h3>
                       

                        <?php
                             include('dao/connect.php');
                            $statement = "SELECT plots.*,  sold_plots.`date_sold`, master_land.`name`,master_land.`location`,member.`first_name`, member.`middle_name`,sale_price FROM `member`
...
WHERE `cur_status` ='Sold' ORDER BY `master_land_id` ASC,`plot_num` ASC";
                                        ...
                                        <td class="dataListHeader">
                                            <div style="float:right; margin-right:20px; width:10%">
                                                ...
                                                <table align="right" width="100%" >
                                                    <tr>
                                                        <td><a href="pdf_plots_sold.php" target="_blank"class="noline"><i class='icon icon-orange icon-print'></i>&nbsp;Print PDF</a></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
                                            ...
                                            <tbody>
                                                ...
                                                $num = 0;
                                                 ...
                                                 while($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td>' ."Ksh. ".number_format($row['sale_price'],2,".",",") . '</td>';
                                                  
                                                  
                                                    ?>
                                               <td><a href="receive_pay.php?id=<?php echo $row['plot_id'] ?>" title="Click to Sell Plot Details"><i  <button type="button" class="btn btn-success  btn-sm"><i class="fa fa-paypal" aria-hidden="true"></i> Payment</button></a></td>    
                                                 <td><a href="recordplot_expense.php?id=<?php echo $row['plot_id'] ?>" title="Click to Sell Plot Details"><i  <button type="button" class="btn btn-dark  btn-sm"><i class="fa fa-bank" aria-hidden="true"></i>Expense </button></a></td>    
