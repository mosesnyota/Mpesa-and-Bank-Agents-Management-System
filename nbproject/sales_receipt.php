...
function getPlotDetails($plot_id) {
...
$name ='';
    while ($row = $result->fetch_assoc()) {
        $name = "Purchase of Plot No.  ".$row['plot_num'].",  Size: [".$row['size']."], ".$row['name'];
    }
    return $name;
}
...
$pdf->Text(14, 79, 'No');
$pdf->Text(44, 79, getPlotDetails($plot_id));
$pdf->Text(165, 79, "Ksh. ".$set_price);
