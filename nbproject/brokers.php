        ...
        <script type="text/javascript" language="javascript" class="init">
                        ...
                        function WarningDelete(id) {
                            ...
                            if (confirm("WARNING !!\n\nYou are about to delete this Member\n\nDo you want to continue?")) {
                                ...
                                window.location = "broker_delete.php?id=" + id;
                                /* $.ajax({
                                 type: "GET",
            ...
            <div id="page-wrapper">
             ...
             <div class="main-page">  
                 <div  class="activity_box activity_box2">
                        ...
                        <h3 class="title1">All Dealers / Brokers </h3>
                       

                        <?php
                             include('dao/connect.php');
                            $statement = "SELECT * FROM brokers";
                                ...
                                <table class="borders" cellpadding="5" cellspacing="0" width="100%">
                                        ...
                                        <td class="dataListHeader">
                                            <div style="float:right; margin-right:20px; width:10%">
                                                ...
                                                <table align="right" width="100%" >
                                                    <tr>
                                                        <td><a href="pdf_brokers.php" target="_blank"class="noline"><i class='icon icon-orange icon-print'></i>&nbsp;Print PDF</a></td>
                                    ...
                                    <td><table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <td><a href="broker_edit.php?id=<?php echo $row['broker_id'] ?>" title="Click to Edit Members Details"><i  <button type="button" class="btn btn-success hvr-icon-float-away btn-sm btn-md"><i class="fa fa-plus" aria-hidden="true"></i> Edit</button></a></td>
                                                <td> <a href="#" onclick="return WarningDelete(<?php echo $row['broker_id'] ?>);" title="Click To Delete"><i <button type="button" class="btn btn-danger btn-sm hvr-icon-sink-away"><i class="fa fa-plus" aria-hidden="true"></i> Delete</button></i></a></td>		
