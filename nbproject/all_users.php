            ...
            <div id="page-wrapper">
             ...
             <div class="main-page">  
                 <div  class="activity_box activity_box2">
                        ...
                        <h3 class="title1">All Staff Members </h3>
                       

                        <?php
                             include('dao/connect.php');
                            $statement = "SELECT staff.*, `role` FROM staff JOIN `staff_category` ON staff.`category` = `staff_category`.`role_id`";
                                            ...
                                            <tbody>
                                                ...
                                                $num = 0;
                                                 ...
                                                 while($row = $result->fetch_assoc()) {
                                                    ...
                                                    ?>
                                               <td><a href="user_edit.php?id=<?php echo $row['member_id'] ?>" title="Click to Edit Members Details"><i  <button type="button" class="btn btn-success hvr-icon-float-away btn-sm btn-md"><i class="fa fa-plus" aria-hidden="true"></i> Edit</button></a></td>
