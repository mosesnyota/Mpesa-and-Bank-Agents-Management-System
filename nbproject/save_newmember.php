...
$query = "INSERT INTO `member`(`idno`,`first_name`,`middle_name`,`last_name`,`kra_pin`,`email`,`phone`,`dob`,gender,date_joined)
VALUES ('$idpas','$fname','$mname','$lname','$kra','$email','$phone','$dob','$gender','$datejoined')";

      if (new SaveData($query)) {
            echo "<script type= 'text/javascript'>alert('New Member Recorded Successfully');</script>";
