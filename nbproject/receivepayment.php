                                            ...
                                            <tbody>
                                                ...
                                                $num = 0;
                                                 ...
                                                 while($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td>' . "Ksh. ".number_format($row['set_price'] * 0.02,2,".",",") . '</td>';
                                                    echo '<td>' . "Ksh. ".number_format($row['set_price'],2,".",",") . '</td>';
                                                  
                                                    ?>
                                               
                                               <td><a href="receivepayview.php?id=<?php echo $row['plot_id'] ?>" title="Click to Sell Plot Details"><i  <button type="button" class="btn btn-success  btn-sm"><i class="fa fa-paypal" aria-hidden="true"></i> RECEIVE PAYMENT </button></a></td>    
