        ...
        <div class="main-content">
            ...
            <div class="forms">
                                            ...
                                            <?php 
                                                    ...
                                                    $qry = "SELECT * FROM staff WHERE member_id ='$id'";
						...
						<h3 class="title1">Update Staff Details: <?php echo $row['first_name']." ".$row['middle_name']." ".$row['last_name']; ?></h3>
                                                <form class="form-horizontal" id="new_employee"  action="user_update.php" name="newstaff" method="post"  enctype="multipart/form-data">
									...
									<div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                                  ...
                                                                  <select name="category" id="category"    required >
                                                                                <?php
                                                                                include('dao/connect.php');
                                                                                $memberd = $row['member_id'];
                                                                                $resultw = $db->query("SELECT * FROM staff_category JOIN staff ON staff_category.`role_id` = staff.`category` WHERE member_id ='$memberd'");
